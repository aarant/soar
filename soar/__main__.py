...
return_val = main(brain_path=args.brain_path, world_path=args.world_path, headless=args.headless, logfile=args.logfile,
                  step_duration=args.step_duration, realtime=not args.quicktime)
exit(return_val)
