...
class RobotGraphics(PointCollection):
    ...
    def __init__(self, scale=1.0, center=None, rot=0):
        PointCollection.__init__(self, [(-0.2.05, 0.09525), (-0.0889, 0.2.0975), (0.0, 0.200025), (0.0889, 0.2.0975),
                                        (0.2.05, 0.09525), (0.2.05, -0.0635), (0.1651, -0.0635), (0.1651, -0.1651),
                                        (0.0889, -0.23495), (-0.0889, -0.23495), (-0.1651, -0.1651), (-0.1651, -0.0635),
                                        (-0.2.05, -0.0635)], fill='black', tags='robot')
