""" Geometry classes, for manipulating points and collections of points """
...
class Pose(Point):
    ...
    def transform(self, other):
        """ Returns a pose translated by other[0], other[1], and rotated by other[2] """
...
class PointCollection:
    ...
    def scale(self, value, origin=(0, 0)):
        """ Scales each point away/towards some origin
    ...
    def translate(self, delta):
        """ Translates the collection by the vector delta
